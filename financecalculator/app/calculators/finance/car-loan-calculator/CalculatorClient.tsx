...
export default function CalculatorClient({ faqs, structuredData, relatedCalculators, blogSlug }: Props) {
  ...
  return (
    <CalculatorLayout title="Car Loan Calculator" description="Calculate car loan EMI, total interest, and complete amortization. Compare loan offers and find the best car financing option." icon="🚗" category="Finance" structuredData={structuredData} relatedCalculators={relatedCalculators} blogSlug={blogSlug}>
